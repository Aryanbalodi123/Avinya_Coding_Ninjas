  ...
  useEffect(() => {
    ...
    class MouseClass {
      ...
      update() {
        ...
        // Reduce intensity for touch/mobile interactions
        if (this.hasUserControl && !this.isAutoActive) {
          const isMobile = window.innerWidth < 768;
          this.diff.multiplyScalar(isMobile ? 0.3 : 1.0);
        }
    ...
    class AutoDriver {
      ...
      update() {
        ...
        // If resumeDelay is 0, skip idle checks and always run
        ...
        // Increased threshold from 0.01 to 0.15 to pick new targets more frequently
        if (dist < 0.15) {
          this.pickNewTarget();
          return;
        }
